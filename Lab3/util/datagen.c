/*
Generate a non-singular matrix and a vector and save the output. (the values are in precision
double)
...
Example:
    >datagen
    generate 100 by 100 non singular double matrix and a vector b with most elements between -100
and 100 in "./data_input"

    >datagen -s 1000 -b 10 -p
    generate 1000 by 1000 non singular double matrix and a vector b with most elements between -10
